              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
                ...
                {infoItems.map(
                  ({
                    ...
                    condition && (
                      <div
                        key={label}
                        className="flex items-center gap-3 text-gray-300 p-3 rounded-lg bg-gray-800/50 transition-colors"
                      >
                        ...
                        <div className={`isLink ? 'flex-1 min-w-0' : ''}`}>
                          ...
                          {isLink ? (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-sm text-blue-400 hover:underline font-semibold truncate block"
                            >
                              {value}
                            </a>
                          ) : (
